...
export async function runAll(report) {
  ...
  const sizeCases = [
    ...
    ['試穿2 腳長23.6 寬9.5（試穿6號）', 236, 95, '建議 6號'],
    ...
    ['超過最大號範圍 28.7（不建議硬穿最大號）', 287, 100, '這款沒有適合你的尺碼'],
    ['最大號接近上限 28.3', 283, 100, '建議 10號'],
  ...
  for (const [sku, cases] of [
    ['11802053', [[240, 95, '建議 24號'], [244, 95, '建議 24號 或 25號'], [280, 100, '建議 28號'], [292, 100, '這款沒有適合你的尺碼'], [219, 90, '這款沒有適合你的尺碼'],
      // 三位同事實拍、尺量確認過的腳長腳寬
      [277, 105, '建議 28號'], [263, 106, '建議 27號'], [223, 89, '建議 23號']]],
    ['11802051', [[250, 95, '建議 25號'], [236, 90, '建議 24號'], [272, 105, '建議 27號 或 28號'], [258, 104, '建議 27號']]],
  ]) {
